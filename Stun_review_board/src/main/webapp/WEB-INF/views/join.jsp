...
<body>
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					...
					<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
						<li class="nav-item"><a class="nav-link active"
							aria-current="page" href="../St_board/login.jsp">로그인</a></li>
				...
				<div class="row gx-5 justify-content-center">
					<div class="col-lg-6">
						...
						<form id="contactForm" data-sb-form-api-token="API_TOKEN">
							...
							<!-- Phone number input-->
							<div class="form-floating mb-3">
								<input class="form-control" name="number" id="phonenumber"
									type="phonenumber" placeholder="(123) 456-7890"
									data-sb-validations="required" /> <label for="phonenumber">연락처</label>
								<div class="invalid-feedback"
									data-sb-feedback="phonenumber:required">A phone number is
									required.</div>
							</div>
	...
	<form action="./UseStunDB.jsp" method="post">
		<div class="d-grid gap-3 d-sm-flex justify-content-sm-center">
			<input class="btn btn-outline-primary" type="submit" value="관리자용확인">
		</div>
	</form>
	<div>
		<br>
	...
	<footer class="py-5 bg-dark">
		<div class="container px-5">
			<p class="m-0 text-center text-white">Copyright &copy; Worm Place
				2021</p>
		</div>
	</footer>
	<!-- Bootstrap core JS-->
